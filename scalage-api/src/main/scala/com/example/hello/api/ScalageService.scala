...
object ScalageService  {
  val TOPIC_NAME = "greetings"
}

/**
  * The scalage service interface.
  * <p>
  * This describes everything that Lagom needs to know about how to serve and
  * consume the ScalageService.
  */
trait ScalageService extends Service {
  ...
  override final def descriptor = {
    ...
    named("scalage")
      ...
      .withTopics(
        topic(ScalageService.TOPIC_NAME, greetingsTopic)
